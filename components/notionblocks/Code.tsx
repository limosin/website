  ...
  return (
    <div className="my-8 w-full">
      <div className="mx-auto max-w-5xl">
        <div className="group relative overflow-hidden rounded-xl border border-gray-200 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 shadow-2xl transition-all duration-300 hover:shadow-3xl hover:scale-[1.02] code-block-glow">
          {/* Animated gradient border */}
          <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-purple-500 via-blue-500 to-teal-500 opacity-0 transition-opacity duration-300 group-hover:opacity-20 blur-sm"></div>

          {/* Language label with icon */}
          {language && language !== "text" && (
            <div className="relative border-b border-gray-700/50 bg-gradient-to-r from-gray-800 to-gray-750 px-6 py-3">
          ...
          <div className="relative">
            {/* Subtle glow effect */}
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-blue-900/5"></div>

            <pre className="relative overflow-x-auto p-6 text-sm leading-7 scrollbar-thin scrollbar-track-gray-800 scrollbar-thumb-gray-600 hover:scrollbar-thumb-gray-500">
              <code
                ref={codeBlock}
                className={`${code_class} block whitespace-pre text-gray-100`}
                style={{
