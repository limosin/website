...
export function LoadingIcon(props: any) {
  ...
  return (
    <svg className={cs(className)} style={loadingIconStyle} {...rest} viewBox="0 0 24 24">
      <defs>
...
export function Loading() {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center p-[calc(min(2vmin,24px))]">
      <LoadingIcon />
    </div>
  )
}
