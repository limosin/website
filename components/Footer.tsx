...
const SocialIcon = ({ href, kind, children }) => {
  if (!href) return null
  return (
    <a className="text-gray-500 hover:text-teal-600 dark:text-gray-400 dark:hover:text-teal-400 transition-colors" target="_blank" rel="noopener noreferrer" href={href} aria-label={kind}>
    ...
    <footer className="mt-16 border-t border-gray-200 dark:border-gray-800">
      <div className="mx-auto max-w-3xl px-4 py-8 md:px-0 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-col items-center md:items-start gap-2">
          ...
          <div className="text-xs text-gray-400 dark:text-gray-500">Building in public.</div>
        </div>
